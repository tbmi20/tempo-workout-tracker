...
- Name: Navigation menu should work correctly
...
Expected: > 0
Received:   0
    at /Users/tbmi/Documents/GitHub/tempo-workout-tracker/tests/playwright/home.test.ts:18:34
```
...
- region "Notifications (F8)":
  - list:
    - status:
      ...
      - button:
        - img
- status: Notification Error loading dataCould not load your data. Please try again later.
```
